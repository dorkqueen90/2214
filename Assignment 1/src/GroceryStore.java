/**This is the driver containing the main method used with the CheckoutQueue and Customer classes.
 *
 * @author Amber Sibel
 * @version 7/11/19
 *
 * This program simulates 60 minutes of activity at a store, allowing each run in the loop to represent 1 min.
 * Each minute will have a 25% chance a new customer appears and added to the CheckoutQueue, and for the customer
...
public class GroceryStore {
    ...
    public static void main(String[] args){
        ...
        CheckoutQueue line = new CheckoutQueue();
